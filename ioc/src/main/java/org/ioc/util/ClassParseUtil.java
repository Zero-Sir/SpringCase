...
public class ClassParseUtil {
        ...
        while (dirs.hasMoreElements()) {
            ...
            if ("file".equals(protocol)) {
                ...
                try {
                    ...
                    e.printStackTrace();
                    throw new IOException("在扫描用户定义视图时从jar包获取文件出错");
                }
            }
        }
        return classes;
     ...
     * @param classes
     */
    private static void findClassesInPackageByJar(String packageName, Enumeration<JarEntry> entries, String packageDirName, final boolean recursive, List<Class<?>> classes) {
        // 同样的进行循环迭代
